"use strict";
let elements_products = document.querySelector('.products')
let elements_buttons = document.querySelectorAll("button")

elements_buttons.forEach(function (el) {
...
function showCategory(category) {
    let product_category = products[category]
    for (let index = 0; index <= product_category.length; index++) {
        elements_products.insertAdjacentHTML("afterend", getProductMarkup(product_category[index]))
    }
}
